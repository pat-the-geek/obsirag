...
from src.api.schemas import (
    ...
    NoteDetailModel,
    PatchConversationEntityRequest,
    QueryOverviewModel,
    RelatedNoteModel,
...
@app.patch("/api/v1/conversations/{conversation_id}/entities", response_model=ConversationDetailModel)
def patch_conversation_entities(
    conversation_id: str,
    payload: PatchConversationEntityRequest,
    _: None = Depends(require_api_auth),
) -> ConversationDetailModel:
    updated = conversation_store.patch_conversation_hidden_entity_values(
        conversation_id,
        [payload.entityValue],
        payload.action,
    )
